const CACHE = 'winston-v0.8.0';
const ASSETS = ['/', '/index.html', '/manifest.json', '/src/features/capture/capture.js', '/icon-192.png', '/icon-512.png', '/apple-touch-icon.png', '/favicon.png'];
